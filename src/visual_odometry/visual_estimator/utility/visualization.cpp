...
ros::Publisher pub_vision_degeneration;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_vision_degeneration = n.advertise<std_msgs::Int16>("/VisionDegeneration", 1000);
...
void pubVisionDegeneration(const std_msgs::Int16  &VisionDegeneration_msg){
    // pub vision degeneration
    pub_vision_degeneration.publish(VisionDegeneration_msg);
}